...
from .Modules import LinearNorm, ConvNorm, get_sinusoid_encoding_table

from ..utils.functional import get_mask_from_lengths, pad
...
class LengthRegulator(nn.Module):
    ...
    def LR(self, x, duration, max_len):
        ...
        return output, position, torch.LongTensor(mel_len).to(x.device)
